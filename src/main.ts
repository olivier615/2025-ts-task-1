...
export type OnShelfPlant = BasicPlant &
  StockInfo /* TODO: BasicPlant, StockInfo 組合 */
...
export const calcTotal: CalcTotalFn /* TODO: CalcTotalFn */ = (
  items,
  coupon,
) => {
...
export type CartPlant = Pick<PlantItem, 'id' | 'name' | 'price'> /* TODO */
export type PublicPlant = Omit<PlantItem, 'weightKg' | 'shipFrom'> /* TODO */

export const cartPlant: CartPlant /* TODO */ = {
  id: 101,
  name: '琴葉榕',
  price: 2500,
}
export const publicPlant: PublicPlant /* TODO */ = {
  id: 101,
  name: '琴葉榕',
  price: 2500,
  currency: 'TWD',
...
*/
type TUpdateProduct = Partial<Omit<TProduct, 'id' | 'title'>> & {
  id: string,
  title: string
}
